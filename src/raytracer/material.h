...
static std::shared_ptr<internal::Material> createMaterial(const glm::vec3& color, float smoothness) {
...
static std::shared_ptr<internal::Material> createEmissiveMaterial(const glm::vec3& color, float power) {
